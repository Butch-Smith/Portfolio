export default {
    ...
    toDoAppDescription: 'Never wanna forget something ever again? Use this very easy to use to-do list application!! Image not related.',
